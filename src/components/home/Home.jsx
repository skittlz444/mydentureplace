      ...
      <React.Fragment>
          ...
          <Container>
            ...
            <Row>
              <Col
                ...
                xs={{ span: 12, order: 2 }}
                lg={{ span: 6, order: 1 }}
                className={styles.homeInfoCol}
              >
                <div>
                  <h2>
                    Warm, Friendly, Professional Staff in a Relaxed Environment
                  </h2>
                  <ul>
                    <li>
                      <h4>Can't Smile with confidence?</h4>
                    </li>
                    <li>
                      <h4>Have trouble eating?</h4>
                    </li>
                    <li>
                      <h4>Have trouble eating?</h4>
                    </li>
                    <li>
                      <h4>Problems with ill-fitting dentures?</h4>
                    </li>
                    <li>
                      <h4>Looking for a mouthguard that fits?</h4>
                    </li>
                  </ul>
                  <hr />
                  <span className="flex justify-content-center">
                    <Button
                      ...
                      variant="light"
                    >
                      <h3 className={styles.actionButtonText}>Get in touch</h3>
                    </Button>
                  </span>
                </div>
              </Col>
        ...
        <Container>
          <Row>
            ...
            <Col>
              <h4>
                Before you get new dentures, you should have all the information
                required help you make the right decision.
              </h4>
              <h4>
                Our aim is to help you to address your concerns and questions.
              </h4>
              <h4>We prescribe and make your dentures directly to you.</h4>
              <h4>Custom made right here, for your inh4idual smile.</h4>
              <h4>
                Naturally shaped teeth from quality European manufacturers.
              </h4>
              <h4>
                Our natural looking dentures consider you and your specific
                needs
              </h4>
            </Col>
          </Row>
